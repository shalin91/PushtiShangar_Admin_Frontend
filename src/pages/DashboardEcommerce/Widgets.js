...
const Widgets = () => {
  ...
  useEffect(() => {
    // Fetch data from your API endpoints and update the state
    // Example: fetch('/api/total-customers').then(response => response.json()).then(data => setWidgetData({ ...widgetData, totalCustomers: data.totalCustomers }));
